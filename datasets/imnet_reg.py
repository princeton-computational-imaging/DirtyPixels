...
_ITEMS_TO_DESCRIPTIONS = {
    'input_img': 'A color image of varying height and width.',
    'gt_img': 'A color image of varying height and width.',
...
def create_readable_names_for_imagenet_labels():
  ...
  Code is based on
  https://github.com/tensorflow/models/blob/master/inception/inception/data/convert_reg_imgnet.py#L463
  """
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
  ...
  keys_to_features = {
      'input_img/encoded': tf.FixedLenFeature(
          (), tf.string, default_value=''),
      'gt_img/encoded': tf.FixedLenFeature(
          (), tf.string, default_value=''),
  ...
  items_to_handlers = {
      'input': slim.tfexample_decoder.Image('input_img/encoded', 'image/format'),
      'ground_truth': slim.tfexample_decoder.Image('gt_img/encoded', 'image/format'),
